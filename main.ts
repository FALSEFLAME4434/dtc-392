namespace SpriteKind {
    export const Puddle = SpriteKind.create()
...
sprites.onOverlap(SpriteKind.Projectile, SpriteKind.RedCar, function (sprite, otherSprite) {
    sprites.destroy(RedCar, effects.spray, 500)
    info.changeScoreBy(10)
})
sprites.onOverlap(SpriteKind.Player, SpriteKind.Puddle, function (sprite, otherSprite) {
...
mySprite = sprites.create(img`
    ...
    . . f b b . . . . f b b . . . . 
    `, SpriteKind.Player)
let mySprite2 = sprites.create(assets.image`Puddle`, SpriteKind.Puddle)
RedCar = sprites.create(img`
    . . . . . . . . . . . . . . . . 
    . . . . . . 2 2 2 2 2 2 2 2 . . 
    . . . . . 2 c 2 2 2 2 2 2 4 2 . 
